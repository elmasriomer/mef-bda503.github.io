...
# Download 2017-11 data and add to main data
print("Getting 2017-11 data from repository")
download.file("https://github.com/MEF-BDA503/pj18-elmasriomer/blob/master/week_3/odd_retail_sales_2017_11.rds?raw=true",destfile=tmprds)
main_data <- bind_rows(main_data,readRDS(tmprds))
